...
function applyPayment(b, order) {
  ...
  return Object.assign({}, b, {
    ...
    /* ============================================================
       `payToRestaurant = 0` — الحقل الرابع الذي كان ناقصاً.

       الثلاثة أعلاه كانت مضبوطة، وبقي هذا يحمل ٩٠ في طلبٍ وصلك
       ثمنه كاملاً. ومن يقرأ الحقل باسمه — «ما يدفعه المندوب
       للمطعم» — يصدّقه: فيدفع المندوب تسعين من جيبه على طلبٍ لم
       يحصّل منه شيئاً، وينتظر أن تعيدها له.

       والفرق ليس نظرياً: `owedToRestaurant` أدناه يقول إنك أنت
       المدين للمطعم. فلو دفع المندوب أيضاً، دُفع المبلغ مرّتين —
       مرّةً منه ومرّةً منك — وضاعت تسعون شيكلاً في كل طلب بلا أن
       يظهر الفرق في أي شاشة.

       وتطبيق المندوب اليوم يقرأ `isPrepaid` ويكتب «لا تدفع للمحلّ»،
       فالحقل لا يُعرض. لكن حقلاً يحمل رقماً خاطئاً وينجو لأن أحداً
       لا يقرأه اليوم هو فخٌّ منصوبٌ لمن يقرأه غداً — ولوحة الإدارة
       تقرأه في تقاريرها.
       ============================================================ */
    payToRestaurant: 0,
